...
public class CSVHeaderWriter {
    ...
    private static void createHeader(int wordCount){
        csvHeader = new String[wordCount+1];
        Arrays.setAll(csvHeader, i -> " Word "+i);
        csvHeader[0] = "";
    }
    private static void writeHeaderToOutputFile(String outputFile){
    ...
    public static void addCSVHeader(int wordCount, String outputFile) throws IOException {

...
public class WordChecksTest {
    ...
    public void testXmlSpecialCharacterCheck() {
        ...
        String[] actualWords = {wordChecks.xmlSpecialCharacterCheck(words[0]), wordChecks.xmlSpecialCharacterCheck(words[1]), wordChecks.xmlSpecialCharacterCheck(words[2])};
        int i = 0;
